...
let inMemorySlots = [
  // Monday CSE 3rd Sem Sec A initial timetable
  {
    id: 1,
    classId: 101,
  ...
  },
  {
    ...
    subjectId: 6,
    subjectCode: "CS305",
    subjectName: "Computer Organization & Arch",
    facultyId: 4,
  ...
  try {
    ...
    try {
      ...
      subjects = [
        ...
        { id: 6, name: "Computer Organization & Arch", code: "CS305", departmentId: 1 },
      ];
    }
...
export const importAdminTimetable = async (req, res) => {
  try {
    ...
    rows.forEach((row, idx) => {
      ...
      const subjectCode = rowData.subjectcode || rowData.subject || rowData.code || "CS301";
